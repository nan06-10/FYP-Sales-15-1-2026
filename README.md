Business Operations & Sales Intelligence Analysis
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/nan06-10/FYP-Sales-15-1-2026/blob/main/FYP_Sales.ipynb)# FYP-Sales-15-1-2026
...
* **Trend Analysis:** Visualized sales cycles to identify daily and monthly peak hours.
* **Product Performance:** Ranked inventory items to see which products drive the most revenue.
* **Operational Efficiency:** Identified low-activity periods where resources could be optimized or costs reduced.
* **Automated Data Cleaning:** Built a pipeline to handle missing data and formatting errors automatically.
...
3. View the generated charts and summaries at the bottom of the notebook.
